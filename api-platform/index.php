...
$resourceNameCollectionFactory = new AnnotationResourceNameCollectionFactory($apiPlatformAnnotationReader, [$modelPath]);
...
/**
 * Basically ApiPlatform\Core\Bridge\Symfony\Validator\Validator without container
 */
...
$exceptionListener = new ExceptionListener($exceptionController, $logger, $debug, new ErrorListener($exceptionController, $logger, $debug));
